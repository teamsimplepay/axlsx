...
class TestStyles < Test::Unit::TestCase
  ...
  def test_parse_font_options
    ...
    assert_equal(@styles.parse_font_options(:b=>1).class, Integer, "return index of font if not :dxf type")
  ...
  def test_parse_fill_options
    ...
    assert_equal(@styles.parse_fill_options(:bg_color => "DE").class, Integer, "return index of fill if not :dxf type")
